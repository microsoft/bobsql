# run-demo.ps1 - Execute all Azure SQL AI demo scripts against the database
...
Write-Host "======================================================" -ForegroundColor Green
Write-Host ""
Write-Host "You can now connect to $serverFQDN / $sqlDatabaseName" -ForegroundColor Yellow
Write-Host "and run ad-hoc queries using:" -ForegroundColor Yellow
Write-Host "  EXEC dbo.usp_vector_search @search_text = N'your question here';" -ForegroundColor White
Write-Host "  EXEC dbo.usp_chat_with_data @user_question = N'your question here';" -ForegroundColor White
