...
SELECT er.session_id, ew.exec_context_id, er.status, er.command, ew.wait_type, ew.resource_description,ew.wait_duration_ms
...
SELECT name, delta_log_bytes_used/(1024*1024) as log_used_mb, delta_log_bytes_used/(1024*1024)/(duration_ms/1000) as log_rate_mbps, duration_ms, snapshot_time FROM 
