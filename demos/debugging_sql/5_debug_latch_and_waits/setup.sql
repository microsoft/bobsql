USE [master]
GO
DROP DATABASE IF EXISTS [whatayearforthetexasrangers]
GO
USE [master]
GO
CREATE DATABASE [whatayearforthetexasrangers] ON  PRIMARY 
( NAME = N'whatayearforthetexasrangers', FILENAME = N'C:\temp\whatayearforthetexasrangers.mdf' , SIZE = 4MB , MAXSIZE = UNLIMITED, FILEGROWTH = 60000Mb)
 LOG ON 
...
go
drop table if exists butthebluejaysbeatus
go
