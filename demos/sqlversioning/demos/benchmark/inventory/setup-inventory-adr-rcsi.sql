-- Setup: Inventory Management — RCSI ON, ADR ON
USE master;
GO
IF DB_ID('inventory_adr_rcsi') IS NOT NULL
    ALTER DATABASE inventory_adr_rcsi SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
GO
IF DB_ID('inventory_adr_rcsi') IS NOT NULL
    DROP DATABASE inventory_adr_rcsi;
GO
CREATE DATABASE inventory_adr_rcsi;
GO
ALTER DATABASE inventory_adr_rcsi SET READ_COMMITTED_SNAPSHOT ON;
ALTER DATABASE inventory_adr_rcsi SET ACCELERATED_DATABASE_RECOVERY = ON;
GO
USE inventory_adr_rcsi;
GO
