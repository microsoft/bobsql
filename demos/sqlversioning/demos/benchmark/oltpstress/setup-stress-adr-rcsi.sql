-- ============================================================================
-- OLTP Stress Setup: stress_adr_rcsi (RCSI ON, ADR ON, no OL)
-- ============================================================================
USE master;
GO
IF DB_ID(N'stress_adr_rcsi') IS NOT NULL
BEGIN
    ALTER DATABASE stress_adr_rcsi SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE stress_adr_rcsi;
END
GO
CREATE DATABASE stress_adr_rcsi;
GO
ALTER DATABASE stress_adr_rcsi SET RECOVERY SIMPLE;
ALTER DATABASE stress_adr_rcsi SET READ_COMMITTED_SNAPSHOT ON;
ALTER DATABASE stress_adr_rcsi SET ACCELERATED_DATABASE_RECOVERY = ON;
GO
USE stress_adr_rcsi;
GO
...
GO
PRINT N'stress_adr_rcsi: Accounts 50K rows (4 NCIs), Orders empty (2 NCIs). Config: RCSI ON, ADR ON, OL OFF';
GO
