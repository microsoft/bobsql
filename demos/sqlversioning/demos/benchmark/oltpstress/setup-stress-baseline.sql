-- ============================================================================
-- OLTP Stress Setup: stress_baseline (no RCSI, no ADR, no OL)
-- ============================================================================
USE master;
GO
IF DB_ID(N'stress_baseline') IS NOT NULL
BEGIN
    ALTER DATABASE stress_baseline SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE stress_baseline;
END
GO
CREATE DATABASE stress_baseline;
GO
ALTER DATABASE stress_baseline SET RECOVERY SIMPLE;
GO
USE stress_baseline;
GO
...
GO
PRINT N'stress_baseline: Accounts 50K rows (4 NCIs), Orders empty (2 NCIs). Config: RCSI OFF, ADR OFF, OL OFF';
GO
