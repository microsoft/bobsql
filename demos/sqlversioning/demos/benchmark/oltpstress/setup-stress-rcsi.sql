-- ============================================================================
-- OLTP Stress Setup: stress_rcsi (RCSI ON, no ADR, no OL)
-- ============================================================================
USE master;
GO
IF DB_ID(N'stress_rcsi') IS NOT NULL
BEGIN
    ALTER DATABASE stress_rcsi SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE stress_rcsi;
END
GO
CREATE DATABASE stress_rcsi;
GO
ALTER DATABASE stress_rcsi SET RECOVERY SIMPLE;
ALTER DATABASE stress_rcsi SET READ_COMMITTED_SNAPSHOT ON;
GO
USE stress_rcsi;
GO
...
GO
PRINT N'stress_rcsi: Accounts 50K rows (4 NCIs), Orders empty (2 NCIs). Config: RCSI ON, ADR OFF, OL OFF';
GO
