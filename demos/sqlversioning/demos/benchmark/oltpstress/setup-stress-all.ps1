<#
.SYNOPSIS
    Sets up all 4 OLTP stress databases.
.DESCRIPTION
    Creates stress_baseline, stress_rcsi, stress_adr_rcsi, stress_adr_rcsi_ol
    with 50K rows each in dbo.StressAccounts.
...
$scripts = @(
    @{ Name = "stress_baseline";    File = "setup-stress-baseline.sql" },
    @{ Name = "stress_rcsi";        File = "setup-stress-rcsi.sql" },
    @{ Name = "stress_adr_rcsi";    File = "setup-stress-adr-rcsi.sql" },
    @{ Name = "stress_adr_rcsi_ol"; File = "setup-stress-adr-rcsi-ol.sql" }
)

Write-Host ""
Write-Host "============================================================" -ForegroundColor Green
Write-Host " OLTP STRESS: DATABASE SETUP" -ForegroundColor Green
...
Write-Host ""
Write-Host "============================================================" -ForegroundColor Green
Write-Host " All 4 OLTP stress databases created successfully." -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
